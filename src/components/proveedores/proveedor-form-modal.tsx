        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          ...
          <div className="flex flex-col-reverse gap-3 border-t border-border pt-4 sm:flex-row sm:justify-end">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-lg bg-[#021541] px-4 py-2 text-sm font-medium text-white transition-opacity hover:opacity-90 disabled:opacity-50 sm:w-auto cursor-pointer"
            >
